...
class RWMB_Media_Field extends RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
			'add'                => apply_filters( 'rwmb_media_add_string', _x( 'Select or Upload Images', 'media', 'pl-emallshop-extensions' ) ),
			'single'             => apply_filters( 'rwmb_media_single_files_string', _x( ' file', 'media', 'pl-emallshop-extensions' ) ),
			'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', _x( ' files', 'media', 'pl-emallshop-extensions' ) ),
			'remove'             => apply_filters( 'rwmb_media_remove_string', _x( 'Remove', 'media', 'pl-emallshop-extensions' ) ),
			'edit'               => apply_filters( 'rwmb_media_edit_string', _x( 'Edit', 'media', 'pl-emallshop-extensions' ) ),
			'view'               => apply_filters( 'rwmb_media_view_string', _x( 'View', 'media', 'pl-emallshop-extensions' ) ),
			'noTitle'            => _x( 'No Title', 'media', 'pl-emallshop-extensions' ),
			'loadingUrl'         => RWMB_URL . 'img/loader.gif',
			'extensions'         => self::get_mime_extensions(),
			'select'             => _x( 'Select Files', 'media', 'pl-emallshop-extensions' ),
			'uploadInstructions' => _x( 'Drop files here to upload', 'media', 'pl-emallshop-extensions' )
		) );
	}
