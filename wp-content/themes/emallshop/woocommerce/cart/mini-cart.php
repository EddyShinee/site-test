...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<ul class="woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">
		...
		<li class="mini_cart_item mini_cart_item_title">
			<?php echo sprintf(_n('Recent add item', 'Recent add item(s)', WC()->cart->cart_contents_count, 'emallshop'), WC()->cart->cart_contents_count);?>
		</li>
		<?php
				...
				<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>" data-cart_item_key="<?php echo esc_attr( $cart_item_key );?>" >
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							...
							esc_attr__( 'Remove this item', 'emallshop' ),
							esc_attr( $product_id ),
					...
					<div class="mini-cart-item-content">
						...
						<?php if( emallshop_get_option( 'mini-cart-quantity', 1 ) ) {	
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'emallshop' ); ?></p>
