...
function emallshop_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             	=> esc_url('https://demo.presslayouts.com/plugins/pl-emallshop-extensions.zip'),
			'version'  				=> '1.3.0',
			'required' 				=> true,
		),
		array(
			...
			'slug' 					=> 'js_composer',
			'source'             	=> esc_url('https://demo.presslayouts.com/plugins/js_composer.zip'),
			'version'  				=> '6.8.0',
			'required' 				=> true,
		),
		array(
			...
			'slug' 					=> 'revslider',
			'source'             	=> esc_url('https://demo.presslayouts.com/plugins/revslider.zip'),
			'version'  				=> '6.5.19',
			'required' 				=> true,
		),
		array(
			...
			'source'             	=> esc_url('https://demo.presslayouts.com/plugins/Ultimate_VC_Addons.zip'),
			'version'  				=> '3.19.11',
			'required' 				=> true,
		),
		array(
			...
			'source'             	=> esc_url('https://demo.presslayouts.com/plugins/clever-swatches.zip'),
			'version'  				=> '2.2.3',
			'required' 				=> false,
		),
		array(
